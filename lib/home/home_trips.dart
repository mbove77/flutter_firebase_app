...
class HomeTrips extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ListView(
          children: [DescriptionPlace("Bahamas", 3.5, dummyText), ReviewList()],
        ),
        HeaderAppBar()
      ],
    );
